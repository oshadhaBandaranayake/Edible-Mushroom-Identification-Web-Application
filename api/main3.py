...
async def prediction(
    ...
    try:
        ...
        if condition:
            ...
            MODEL = tf.keras.models.load_model("/content/drive/MyDrive/Modelm")
            class_names = ["abloni", "oyster", "new_class"]
        ...
        if predicted_class_idx < len(class_names):
            ...
            class_messages = {
                "abloni": "Custom message for abloni",
                "oyster": "Custom message for oyster",
                "new_class": "Custom message for new_class",
                # Add more classes and custom messages as needed
            }

            class_message = class_messages.get(predicted_class, "No custom message available")
